...
extension INSERT {
    ...
    func newIncision(aview: UIView, parameters: [String : Any], dispachInstance: DispatchGroup){
        ...
        let request = NSMutableURLRequest(url: NSURL(string: Constants.instantShare.Incisions.insertIncision)! as URL,
