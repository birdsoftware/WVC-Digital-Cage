//
//  DELETEIncision.swift
//  WVC Digital Cage
//
//  Created by Brian Bird on 12/27/18.
...
extension DeleteInstantShare {
    ...
    func Incision(aview: UIView, parameters: [String : Any], dispatchInstance: DispatchGroup) {
        /*{
         "incisionsId"   : "10"
         }*/
        let messgTitle = "Incision"
        let headers = [
            "content-type": "application/json"
        ]
        
        let postData = try! JSONSerialization.data(withJSONObject: parameters, options: [])
        let request = NSMutableURLRequest(url: NSURL(string: Constants.instantShare.Incisions.deleteIncision)! as URL,
